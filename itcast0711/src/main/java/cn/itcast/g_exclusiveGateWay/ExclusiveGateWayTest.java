...
//		InputStream inputStreamBpmn = this.getClass().getClassLoader().getResourceAsStream("exclusiveGateWay.bpmn");
//		InputStream inputStreamPng = this.getClass().getClassLoader().getResourceAsStream("exclusiveGateWay.png");
		InputStream inputStreamBpmn  = this.getClass().getClassLoader().getResourceAsStream("diagrams/exclusiveGateWay.bpmn");
		InputStream inputStreamPng = this.getClass().getClassLoader().getResourceAsStream("diagrams/exclusiveGateWay.png");
