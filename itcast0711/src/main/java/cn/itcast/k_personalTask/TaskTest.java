...
//		InputStream inputStreamPng = this.getClass().getResourceAsStream("task.png");
		InputStream inputStreamBpmn  = this.getClass().getClassLoader().getResourceAsStream("diagrams/task.bpmn");
	...
	public void startProcessInstance(){
		...
		System.out.println("流程定义ID:"+pi.getProcessDefinitionId()+"流程定义name:"+pi.getName());//流程定义ID   helloworld:1:4
	}
