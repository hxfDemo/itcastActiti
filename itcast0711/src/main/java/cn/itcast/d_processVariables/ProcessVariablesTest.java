...
//        String taskId = "6104";
        ...
        p.setName("如花");
        p.setEducation("本科");
        taskService.setVariable(taskId, "人员信息（BB)", p);
...
//        String tackId="6104";
//
//        Person person = (Person) taskService.getVariable(taskId, "人员信息（BB");
    ...
    public void findHistoryProcessVariables() {
        ...
        if (list!=null&&list.size()>0) {
            for (HistoricVariableInstance instance : list) {
                System.out.println(instance.getId()+"********"+instance.getTaskId());
            }
        }
    }
}
